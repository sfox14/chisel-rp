...
lazy val utils = RootProject(uri("git://github.com/da-steve101/chisel-utils.git"))
lazy val olk = RootProject(uri("git://github.com/da-steve101/chisel-pipelined-olk.git"))

lazy val randp = (project in file(".")).settings(rpSettings: _*).dependsOn(chisel).dependsOn(olk).dependsOn(utils)
